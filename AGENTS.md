...
│   ├── opencode.md                         `/rocky:opencode` — task 를 opencode(opencode run)에 위임(격리 worktree) + Claude 감시(게이트/표면/스코프), 자동 병합 X
