...
└── src/
    ...
    └── core/                               ← 구 @minjun0219/openapi-core
        ...
        ├── opencode-cli.ts                 opencode CLI 어댑터 (v0.17) — buildRunArgs / detectOpencode / NDJSON 요약 / Bun.spawn executor (fakeable)
